      ...
      <div className="max-w-2xl">
        <RecordForm action={createExpense} redirectTo="/expenses" submitLabel="Record expense">
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <FormField label="Tax" name="taxAmount" hint="Recoverable tax, if any.">
            ...
            <FormField label="Project" name="projectId" hint="Required if billing it on.">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <FormField label="Or paid to supplier" name="vendorAccountId">
